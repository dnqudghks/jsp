		...
		<section class="w3-col">
			<div class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding">
				<div class="w3-col w120 w3-center pdAll10">
					<img src="/cafe/img/avatar/${AVATAR}" class="inblock w3-circle avtBox100 border3px w3-card-2">
					<span class="w3-col mgt10 ft10"><b>${SID}</b></span>
				</div>
				<div class="w3-rest w3-padding w3-border-left h100per">
					<form method="POST" action="/cafe/reBoard/reBoardReplyProc.cafe" name="frm" id="frm" class="w3-col">
						<input type="hidden" name="upno" id="upno" value="${UPNO}">
						<div class="w3-col">
							<span class="w3-col m2 mgt10 w3-text-grey ft14"><label><b>원글제목</b></label></span>
							<div class="w3-col m10 pdl10">
								<input type="text" class="w3-input w3-text-blue w3-border-0 ft14" value="${UPTITLE}" disabled>
							</div>
						</div>
