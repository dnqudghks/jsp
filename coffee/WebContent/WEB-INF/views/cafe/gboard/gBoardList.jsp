...
<body>
	...
	<c:if test="${not empty SID}">
		<c:if test ="${CNT == 0}">
			<div class="w3-col w150 w3-left w3-button w3-lime w3-right" id="wbtn">${CNT}글작성</div>
		</c:if>
			<div class="w3-col w150 w3-left w3-button w3-light-green w3-right" id="outbtn">logout</div>
	</c:if>
	<c:if test="${empty SID}">
			<div class="w3-col w150 w3-left w3-button w3-deep-orange w3-right" id="rbtn">login</div>
...
<c:forEach var="data" items="${LIST}">
		<div class="W3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding">
			...
			<div class="w3-col w3-border-bottom">
				...
				<span class="w3-right mgb10 ft10"><b>${data.sdate}</b></span>
			</div>
